...
- Пиглины при обмене всегда выдают две единицы магмового крема.
- Только что выпавшие из блоков предметы разлетаются от ближайшего игрока; выброшенные вручную предметы сохраняют обычное направление броска.
- Экипировка мобов не выпадает.

### Враждебные мобы

- Зомби и их разновидности всегда появляются детьми.
- Зомби получают оружие и экипировку с учётом локальной сложности.
- Утопленники всегда вооружены трезубцами.
...
- Далёкие враждебные мобы больше не занимают моб-кап навсегда.
...
- Механика фиксированного сида мира из оригинального мода намеренно не перенесена.
